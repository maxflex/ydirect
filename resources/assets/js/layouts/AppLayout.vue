<template>
  <v-app id="inspire">
      ...
      <v-list dense>
        <v-list-group
         ...
         >
           ...
           <v-list-tile v-for="campaign in campaigns" :key="campaign.id" @click="selectCampaign(campaign)">
             <v-list-tile-action>
               <v-list-tile-title>{{ campaign.title }}</v-list-tile-title>
             </v-list-tile-action>
           </v-list-tile>
         </v-list-group>
        <v-list-tile @click="">
          ...
          <v-list-tile-content>
            <v-list-tile-title>Ставки</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile @click="">
          <v-list-tile-action>
    ...
    <v-toolbar app fixed clipped-left>
      ...
      <v-toolbar-title>
        <span v-if="$store.state.campaign != null">{{ $store.state.campaign.title }}</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn icon>
